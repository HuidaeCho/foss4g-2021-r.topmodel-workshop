...
An `r.topmodel <https://grass.osgeo.org/grass78/manuals/r.topmodel.html>`_ input file contains weather forcing data including rainfall and potential evapotranspiration time series data.
